...
const contractABI = require("../artifacts/contracts/Raftcompass.sol/Raftcompass.json").abi;

program
    .name("raftcompass-cli")
    .description("CLI tool for Raftcompass smart contract")
    .version("1.0.0");
