 ...
 * This file demonstrates how to integrate Raftcompass with a web frontend
 */

// For React/Vue/Angular applications
export class RaftcompassClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new RaftcompassClient(provider, contractAddress);
